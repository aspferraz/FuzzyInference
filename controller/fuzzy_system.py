from controller.knowledge.fuzzy_rule import FuzzyRule

import matplotlib.pyplot as plt

'''
author: https://github.com/carmelgafa
last modified by https://github.com/aspferraz 
date 2020-05-11
'''
class FuzzySystem:
	'''
	...
	def _clear_output_distributions(self):
		...
		'''
		for output_var in self._output_variables.values():
			output_var.clear_output_distribution()
	...
	def evaluate_output(self, inputs):
		...
		Arguments:
		-----------
		inputs -- dict, containing the inputs to the systems in the form
	...
	def evaluate_output_info(self, inputs):
		'''
		Executes the fuzzy inference system for a set of inputs
